...
ALTER TABLE `TBL_MEMBER` MODIFY `JOIN_DATE` TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE ddschool.tbl_sticker CHANGE STIKER_NUM STICKER_NUM INT NOT NULL;

ALTER TABLE ddschool.tbl_class 
ADD COLUMN STATUS TINYINT NOT NULL DEFAULT '1' AFTER CLASS_NAME;

ALTER TABLE ddschool.tbl_classbook
ADD `STATUS` BOOLEAN NOT NULL DEFAULT 1;
ALTER TABLE ddschool.tbl_classbook
MODIFY COLUMN `CHECK_DATE` DATE DEFAULT (CURRENT_DATE);
ALTER TABLE ddschool.tbl_classbook
MODIFY COLUMN `CHECK_STATUS` VARCHAR(20);

ALTER TABLE ddschool.tbl_dog
ADD `NOTES` VARCHAR(30) NULL;
ALTER TABLE ddschool.tbl_dog
