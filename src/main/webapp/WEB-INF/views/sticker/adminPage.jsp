...
<body>
	...
	<main class="main-content">
		<div class="sticker-header-content sticker-container">
			<h2 class="sticker-item">
				<span style="font-weight: 900;">우리 댕댕이</span>를 <br> 칭찬합니다.
			</h2>

			<form
				action="${ pageContext.servletContext.contextPath }/sticker/list"
				method="get" class="container-item">
			...
			<c:if test="${roleCode == '2'}">
				<form
					action="${ pageContext.servletContext.contextPath }/sticker/insert"
					method="get">
				...
				<table align="center" id="listArea">
					...
					<c:forEach var="sticker" items="${ requestScope.stickerList }"
						...
						<tr>
							...
							<td><input type="hidden" class="stickerCode"
								value="${sticker.stickerCode}"> <c:if
									test="${roleCode == '2'}">
									<button class="submit-mini-button" id="updateButton"
										onClick="updatePost(${ sticker.stickerCode })">수정</button>
									<button class="submit-mini-button" id="deleteButton"
										onClick="deletePost(${ sticker.stickerCode })">삭제</button>
								</c:if></td>
