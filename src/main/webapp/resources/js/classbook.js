...
$(document).ready(function() {
	...
	function updateAdminTableData(tableId, data) {
		...
		var keys = Object.keys(data[0]); // 데이터의 첫 번째 객체의 키들을 가져옴
		console.log(keys);
...
/*<div id="myModal" class="modal">
	<div class="modal-content">
		...
		<p>출결 ID: <span id="modalAttendanceId"></span></p>
		<p>학생 이름: <span id="modalStudentName"></span></p>
		<p>출결 날짜: <span id="modalAttendanceDate"></span></p>
